...
function Contact() {
  ...
  return (
    <section id="contact" className="md:grid md:grid-cols-[40%_60%] lg:grid-cols-2 md:grid-rows-1 md:items-start md:gap-4 pt-[70px] sm:pt-[78px] pb-4 sm:pb-8 px-[5%] sm:px-[10%] xl:px-[15%] 2xl:px-[20%]">
      ...
      <form action="" className="md:row-start-1 md:col-start-2">
