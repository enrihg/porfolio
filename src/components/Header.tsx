    ...
    <>
      <nav className="fixed top-0 z-10 w-screen flex justify-between items-center p-4 text-1000 bg-50 dark:bg-1000">
        ...
        <ul className="hidden sm:flex gap-8 ">
          ...
          <li className="text-1000 hover:text-700 active:text-800 dark:text-white dark:hover:text-500 dark:active:text-600"><a href="#skills">{t("navbar.technologies")}</a></li>
